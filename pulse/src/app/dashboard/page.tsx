  ...
  return (
    <main className="min-h-screen bg-base px-6 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Manage Creators link */}
        <div className="mb-4">
          <a
            href="/dashboard/creators"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-zinc-400 hover:text-white transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-accent rounded"
          >
            Manage Creators
